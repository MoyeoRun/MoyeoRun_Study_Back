...
const kakao_strategy_1 = require("../passports/kakao.strategy");
...
OauthModule = __decorate([
    common_1.Module({
        imports: [user_module_1.UserModule, auth_module_1.AuthModule, passport_1.PassportModule, axios_1.HttpModule],
